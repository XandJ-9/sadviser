# 序言
<a href="./docs/基于技术指标的股票投资建议平台深入研究报告.md">基于技术指标的股票投资建议平台深入研究报告</a>
<a href="./docs/股票投资建议平台技术实现指南.md">股票投资建议平台技术实现指南</a>
<a href="./docs/股票投资建议平台：指标计算与策略框架设计思路.md">股票投资建议平台：指标计算与策略框架设计思路</a>
<a href="./docs/回测模块设计思路与功能说明.md">回测模块设计思路与功能说明</a>
...
结构设计说明：
模块化划分：按 “数据→计算→服务→前端→部署” 全流程拆分，各模块职责清晰，降低耦合。
可扩展性：通过基类（如base_strategy.py）和版本化（如api/v1）支持功能扩展，新增策略或 API 版本时无需重构整体结构。
环境隔离：配置文件、依赖管理区分开发 / 测试 / 生产环境，确保部署一致性。
