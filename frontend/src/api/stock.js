...
export async function getStockHistory(symbol, params = {}) {
  return api.get(`/api/stocks/${symbol}/history`, params);
}
...
export async function getStockQuote(symbols) {
  ...
  return api.get('/api/stocks/quote', { symbols: symbolList });
}
...
export async function searchStocks(keyword, params = {}) {
  return api.get(`/api/stocks/search/${keyword}`, params);
}
...
export async function getHotStocks(params = {}) {
  return api.get('/api/stocks/hot', params);
}
...
export async function getMarketOverview() {
  return api.get('/api/stocks/market/overview');
}
